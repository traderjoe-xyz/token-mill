...
contract CliffVestingContractTest is Test {
    ...
    function setUp() public {
        ...
        vesting = new CliffVestingContract(address(this), token, start, cliffDuration, vestingDuration);
    }
    ...
    function test_Initialize() public {
        assertEq(vesting.factory(), address(this), "test_Initialize::1");
    ...
    function test_SetBeneficiary() public {
        ...
        vm.prank(alice);
        vm.expectRevert(ICliffVestingContract.CliffVestingContract__NotFactoryOwner.selector);
    ...
    function test_Release() public {
        ...
        vm.expectRevert(ICliffVestingContract.CliffVestingContract__NotBeneficiary.selector);
        vesting.release();
