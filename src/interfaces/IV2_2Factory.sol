...
interface IV2_2Factory {
    ...
    function setLBPairIgnored(address tokenX, address tokenY, uint16 binStep, bool ignored) external;
    ...
    function removeLBHooksOnPair(address tokenX, address tokenY, uint16 binStep) external;
    ...
    function removeQuoteAsset(address quoteAsset) external;

    function forceDecay(address lbPair) external;
}
